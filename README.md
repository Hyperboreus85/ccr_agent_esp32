...
Sketch minimale per ESP32 Dev Module per leggere il sensore ZMPT101B su ADC1 (GPIO34) e stampare valori di debug via seriale, con Wi‑Fi connesso in STA.
...
| OUT | GPIO34 (ADC1) | Evita ADC2 quando usi Wi‑Fi |
...
`raw_rms` è l'RMS della componente AC (bias DC rimosso dalla finestra).

## Note
- Usa ADC1 su GPIO34 con `analogReadResolution(12)` e `analogSetPinAttenuation(34, ADC_11db)`.
